...
%
This is particularly useful, as it allows to typecheck functions such
as \ocaml{fun bag x -> bag#mem x} without annotations. Here, the method
invocation 
...
While such defaulting is relatively uncommon
with polymorphic methods, it becomes essential for more recent features such
...
@Gabriel weighs in to break this stalemate.}
