...
also help provide declarative typing rules (\cref{sec:language}) for each fragile
...
declarative typing rules for the surface language (\cref{sec:language}).
...
$\Cshape \C \t \sh$ (defined below) ensures that $\sh$ is uniquely determined by the context $\C$.
