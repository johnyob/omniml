...
inference, reflecting that \textbf{p}olymorphic expressions must be typed
before their \textbf{i}nstances. 
...
% LocalWords:  reimplementation parameterizing redefinable subcase
% LocalWords:  bidirectionality
