...
preventing unwanted sharing of annotation variables that could otherwise block generalization. 
For example, $\efun {\x : \tpoly \ts} {\einst \x}$, which is syntactic sugar for 
$\efun \x {\elet \x {\eannot \x {} {\tpoly \ts}}} {\einst \x}$, is well-typed 
becuase the explicit annotation introduces a fresh annotation variable $\ava$ 
...
% This paragraph also performs the duty of linking PolyML and OCaml in the below examples
