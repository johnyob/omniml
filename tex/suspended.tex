...
\begin{mathparfig}[t]
  ...
  \entry[Shapes] {\Shapes \ni \Sh} {\any \tvcs \t}
  \\
  \entryset[Canonical principal shapes] {\sh} {\Shapes}
  \end{bnfgrammar}
  \par
  \inferrule[Var]
    {x : \sigma \in \G}
...
\end{mathparfig}
\Xalistair{I wanted to link shapes and canonical shapes in the above figure, but it required as $\ni$. 
...
%% \Subparabox[fig/ref/typing/core]{Typing rules --- Structural tuples}{}
  ...
  \inferrule[Rcd-X]
    {\parens{\G \th \ei : \tyi}\iton \\ \parens{{\labfrom \elabi \T} \leq \t \to \tyi}\iton \\ \Dom {\labenv(\T)} = \elabs }
    {\G \th \exrecord \T {\elaba = \ea; \ldots; \elab_n = \en} : \t }
