...
\cref{fig:solver-basic} contains a selected set of basic solving rules that
are standard in small-step constraint solvers for ML type inference.
%
...
\cref{fig:solver-schemes} also describes the generalization rules.
...
\cref{fig:solver-susp} describes the rules for discharging match
constraints.
