...
\XDR{Fix citations for row polymorphism}
\citep*{conf/popl/RemyV97, conf/lics/Wand89, journals/toplas/Ohori95,
garrigue1998programming} or higher-kinded types \citep*{journals/jfp/Jones95},
preserve principality straightforwardly. Others, such as GADTs
...
\end{program}
%
The expression \ocaml!one! can only be \code{int one}. Similarly, \code{r.y}
necessarily infers \code{one} for the type of \code{r}. By constrast,
\code{r.x} is ambiguous unless the type of \code{r} is \emph{known}.
%
