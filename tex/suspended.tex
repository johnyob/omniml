...
information.  For example, the constraint corresponding to a call
$\eannot {\eapp \xmk \ea}{}{\foo}$ in~$\e$ would disambiguate the record $\ct$ through back-propagation.
...
this scheme and refine them later if the shape of $\tvmkret$ becomes known.
\end{local}
