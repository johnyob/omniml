...
standard metatheoretic properties: \emph{progress}, \emph{preservation}, and \emph{termination}. 
Together, they ensure that every satisfiable constraint eventually reduces to an equivalent solved form. 

% Properties
% May look like space hacks, but restatable introduces its own space

\begin{definition}
A constraint $\c$ is term-variable-closed if all its term variables $\x$ are bound \ie $\fvs \c \subseteq \TyVars$. 
\end{definition}
