  ...
  \begin{mathpar}
    ...
    \infer* [Right=Rcd-Proj-I]
      {\eshape \E {\eannot r {} \ttpoint} {\ttpoint} \\
       \infer* [Right=Rcd-Proj-I]
        { \eshape \Ep r \ttpoint \\ 
          \eset \th \Ep \where{\exfield r \ttpoint \ttx} : \ttpoint \to \tint \tprod \tint }
        {\eset \th \underbrace{\Ep\where{\efield r \ttx}}_{\E\where{\exfield r \ttpoint \tty}} : \ttpoint \to \tint \tprod \tint}
      }
      %--------------------------------------------------------------------------------------
      {\eset \th \E\where{\efield {\eannot r {} \ttpoint} \tty} : \ttpoint \to \tint \tprod \tint }
