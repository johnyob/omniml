...
\smashcolorbox{illtyped}{\strut errors (\xmark)} (\ie without the
\code{-warn-error} flag\footnotecref{fn/principal})
%
...
\footnote{%
  For simplicity, \PolyML annotations are restricted to closed types. Both
  \citet{\BBpolyml} and our work support a more general form with existentially 
  quantified type variables, as commonly used in \OCaml. 
