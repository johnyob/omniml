...
judgment $\thsimple$ plays a role analogous to $\throbust$ (from ??): it is
introduced solely to avoid well-foundedness issues.
...
applied to the corresponding branch $\ci$. Hence, it suffices to only define
...
% LocalWords:  impredicativity PolyML knownness mathpar polybidir nihilo fn
...
% LocalWords:  explicits mathescape annotability QuickLook Quicklook Zp
