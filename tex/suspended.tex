...
% being fragile, we use \afterpage (which executes it contents after a pagebreak)
...
\begin{figure}[!tp]
  ...
  \begin{mathparsubfig}
    ...
    {Syntax and semantics of region-based $\Let$ and partial instantiation constraints.}
...
Our algorithm is largely standard, with it main novelty being the use of
