...
\begin{abstract}
  ...
  constructs. However, the rigidity of a \emph{static} inference order often causes
  well-typed programs to be rejected. 
...
\TODO{This section needs revising after the reshuffling}
...
\emph{known} from the surrounding context. This ``out of thin
air'' behavior does not match the intended
