...
subexpressions \emph{simultaneously}, until they are \code{let}-bound.\footnote
%
...
intuitively in explanations.}\XDR{Then, we should not refer to a
...
$\E$ or $\Lab$ for implicit rules \Rule {Proj-I}, \Rule {Use-I}, \Rule
{Poly-I}, and \Rule{Lab-I}.\XDR{No illustration of \Rule{Lab-I}...}
