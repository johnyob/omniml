...
%
This is particularly useful, as we would still like to typecheck functions such
as \ocaml{fun l x -> l#mem x} without annotations. Here, the method invocation
$\ttlab l \esend \ttlab {mem}$ introduces an unboxing operation, becoming
$\einst {\texttt{l} \esend \texttt{mem}}$. At this point, the defaulting rule
assigns \ocaml{l}'s \ocaml{mem} field the \emph{monomorphic} polytype 
$\tpoly {\tva \to \tvb}$.

While such defaulting is relatively uncommon with polymorphic methods, it
becomes essential for more recent features such as polymorphic parameters
