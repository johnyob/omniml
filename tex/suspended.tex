...
in which constraints are solved.} uses a single-pass architecture
...
$\E$ in our system; thus, omnidirectionality conceptually subsumes
contextual typing.  
%
However, omnidirectionality alone cannot subsume all bidirectional systems. In
particular, systems for implicit first-class polymorphism require
\emph{default rules}, as discussed in
\cref{sec/default-rules/poly}.\XDR[There are deeper differences: contextual
