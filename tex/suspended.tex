...
To decide when $\cdetermines \c \tvs$, we introduce the judgement $\th \cdetermines \c \tvs$,
which synatically proves that $\tvs$ are determined in $\c$. 
%
...
context $\C$ \emph{proves} that the scruitinee $\t$ has the unique shape $\sh$,
