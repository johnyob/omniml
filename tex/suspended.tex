...
While such defaulting is relatively uncommon with polymorphic methods,
it becomes essential for more recent features such
as polymorphic parameters
\citep*{\BBpolyparams}, which introduce polytype boxing and unboxing
at every function application.
...
\begin{program}[input]
type 'a gpoint = { x : 'a; y : 'a }                     °\ocamlflags 20°
let diag (n : 'a) : 'a gpoint = { x = n; y = n }
°\halfline°
let ex_8 gp = let getx p = p.x in getx (diag 42), (getx gp : float)
\end{program}
