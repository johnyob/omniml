...
\Xalistair{We don't get stuck. I don't see the problem here, the \NoRule{Uni-*}
rules simply looks for a multi-equation or apply back propagation. There is no
solving here. It is an entirely different set of rules (hence the \NoRule{Uni-}
prefix instead of \NoRule{S-})}
