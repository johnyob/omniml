...
\XDR[TODO]{Say why (a transcription of) \code{ex_6} would fail. Comment on
the weakness of the system in \cref{fig:bidir-poly} and points to the
discussion in
\cref{fig/related-work}.}
