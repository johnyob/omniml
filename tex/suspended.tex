...
\OCaml, the mechanism for implementing annotation variables even comes
\emph{for free}, as a byproduct of the extensive optimizations in its inference
algorithm.
