...
\Let-constraints, since this is the default parenthezising rule. Unless we
wish to make \Let-constraint a concept itself, but then, we should also
put a dash when \Let-constraint apperas alone as in the second occureence}
...
\bigwedge \PARENS {
  ...
  \end{array}
\end{mathpar}
The first conjuct is satisfiable, since $\tvp_1$ is unified with $\trcd
...
an instantion of $\x$, the variable $\tvb$ may range over any free variable
...
\Xgabriel{I disagree for two reasons. One is technical: this
  ...
  opportunity.}
%
\XDR{I let you decdice where to put it.  The text may be change. We may say
...
sure this would be one of Henglein's first reaction, and he would be write.
Of course, Henglein never thought about this and this note is of course not
at all enough for doing suspended constrains, but the incremental
instantiation was already there---and we should not ignoe it.
}
