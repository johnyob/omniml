...
The unicity conditions contain negative occurrences of the typing judgment;
it remains well-founded because these are typing assumptions on erased
terms, that do not themselves contain any implicit rules. Formally one could
define a restricted system $\G \throbust \e : \t$ without the implicit rules
(\Rule{*-I}), and use this strictly simpler judgment in the unicity
