...
\parcomment {Omnidirectionality is not bidirectionality }
...
\end{mathpar}
As in our setting, defaulting may result in rejecting programs that the programmer 
would otherwise be well-typed. \TODO{Add precise example.}

% Hard to compare CT and OmniML
Thus, a more precise account of the relationship between omnidirectionality
