...
%
revealing difficulties in scaling it to features where the typing rule itself 
depends on disambiguation---such as polymorphic records and GADT patterns in \OCaml.
In contrast, omnidirectional inference naturally accommodates such non-uniformity 
in typing rules. 

\XDR{Is
is clear that they would fail with polymorphic record fields? Is it the
HasField constraint that does not allow polytypes?} 

\Xalistair{I added a link to where it discusses that polymorphic fields are not permitted. }
