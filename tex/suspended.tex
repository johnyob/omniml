...
Polymorphic methods \citep*{Garrigue-Remy/poly-ml} bring a form of
...
\begin{bnffig}[tb]
  {fig:polyml-syntax}
  {Selected syntax for polytypes \citep*{Garrigue-Remy/poly-ml}.}
     \entry[Terms]{\e}{
       \epoly[\ts] \e
       \and \einst \e
       \and \eannot \e {} \t
...
\begin{enumerate*}
  ...
  \item Polytypes underpin other features in \OCaml, notably the recent
    addition of polymorphic function parameters \citep*{White/polyparams@ml2023}.
...
\citep*{White/polyparams@ml2023}, which introduce polytype boxing and unboxing
...
Polytypes, introduced by \citet{Garrigue-Remy/poly-ml}, allow so-called
...
%
By contrast, for implicit first-class polymorphism, it remains unclear whether
inference using omnidirectionality can be achieved \emph{without} default
rules---a mechanism also used in bidirectional systems, \eg \DK's
\textsc{$\hat\tv$App} rule.
...
\begin{mathparfig}[htpb!]
  {fig:polyml}
  {\Geninst-directional syntax and typing rules for polytypes from \PolyML~\citep*{Garrigue-Remy/poly-ml}.}
...
\PolyML~\citep*{Garrigue-Remy/poly-ml}, given in \cref{fig:polyml}.
%
\parcomment {Boxing}
%
...
\citep{Pottier-Remy/emlti}, generalization-related rules operate on constraints
...
\end{mathpar}
%
This rule, due to \citet*{Pottier-Remy/emlti}, resembles $\beta$-reduction in
...
\OutsideInX~\citep*{Vytiniotis-Peyton-Jones-Schrijvers-Sulzmann/outsidein@jfp2011},
