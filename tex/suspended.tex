...
\emph{polytype}: a polytype is a \emph{boxed} type scheme $\tpoly \ts$ that
...
\emph{known}, it is defaulted to a monomorphic polytype. 
%
...
Using this approach, we can give typing rules for polytypes; this yields
precisely the formulation introduced in
