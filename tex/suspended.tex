...
\citep*{conf/popl/PierceT98} and \emph{\geninst-directional} \citep*{\BBpolyml}
type inference. Each impose some \emph{static} ordering of inference, using it
to propagate inferred types and user-provided annotations as \emph{known}
information.
