...
\item[(\cref{sec:implementation})]
  ...
  Implementing efficient incremental instantiation is non-trivial in comparison
  to ordinary \ML instantiation, as refinements of partial type schemes must
  trigger re-instantiations without introducing redundant constraint solving
  across successive instantiations of the same scheme.
