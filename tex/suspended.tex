...
\csolve^+
  &\C\Where{
      ...
      \cexistsi {\tvcgetx, \tvpc, \tvcgetxret, \inst} \xgetx 
        {\bigwedge \PARENS 
          { \cpinst \inst \tvp \tvpc \cand \cpinst \inst \tvc \tvcgetxret \\ 
          \cunif {\tvcgetx} {\tvpc \to \tvcgetxret} \cand \cunif \tvpc {\trcd \tgpoint \tint} \cand \cunif \tvcgetxret \tvd }}
  }
  & \Rule{U-Merge}\\[2ex]
\csolve
  &\C\where{
...
\csolve
    &\C\Where{
        ...
        \cexistsi {\tvcgetx, \tvpc, \tvcgetxret, \tvcgetxret', \inst} \xgetx 
          {\bigwedge \PARENS 
            {\cpinst \inst \tvgetxret \tvcgetxret \cand \cpinst \inst \tvgetxret {\tvcgetxret'} \\ 
            \cunif {\tvcgetx} {\tvpc \to \tvcgetxret} \cand \cunif \tvpc {\trcd \tgpoint \tint} \cand \cunif \tvcgetxret \tvd \\ 
...
\Xalistair{@Didier any suggestions for improving the \LaTeX here?}
