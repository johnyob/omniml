...
principality and do not gain from omnidirectionality.
  \Xalistair{@Didier, does this work?}
\end{abstract}
\maketitle
...
\item
  Three instantiations of our framework that give new declarative type
...
\end{program}
Here, \code{x} and \code{z} appear together only in the type \code{two},
...
\cinfer {\efield \e \elab} \tva \wide\eqdef
  ...
  \cmatch \tvb
      {\cbranch {\cpatrcd \ct}
	{\parens {\labenv(\labfrom \elab \ct) \leq \tvb \to \tva}}
      }
\end{mathpar}
...
such as polymorphic fields or GADT constructors.
