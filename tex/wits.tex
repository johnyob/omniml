...
\end{enumerate*}
\XDR{Points 2 and 3 are unclear: as this asumes that one already know what bidirectional type inference is.}
%
...
\begin{enumerate}
  ...
  \item
    A formalized constraint solver as a series of non-deterministic rewriting
