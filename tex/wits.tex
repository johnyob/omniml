...
environment.
%
We solve this \Xjeremy{An example that combines let-bindings and static overloading would strengthen the argument here: would \texttt{let f = fun r -> r.x in  f \{color; x; y\}} work?} by introducing two novel devices:
\begin{enumerate*}

  \item \emph{suspended match constraints}, which defer disambiguation until
    sufficient contextual information is known, and

  \item \emph{incremental instantiation} \ie the ability to instantiate type
