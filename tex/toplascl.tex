...
authored by myself, Gabriel Scherer, and Didier R\'emy.

\XDR{Wouldn't you like to either keep the paper author's order (which we may
decide to change) or the alphabetical order, except for ``yourself'' that
you would then put last?}
...
demand-driven order.
\XDR[add?]
{Omnidirectionaly is particularly difficult to achieve in the presence of
local let-generalization, as required in \OCaml.}
