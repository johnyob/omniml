...
> methods, most notably bidirectional typechecking, because they rely on the
> propagation of known type information; omnidirectionality addresses this same
> need using *global* inference.
